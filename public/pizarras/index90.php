                ...
                $.ajax(
                    "panel/currencies/currencie.php?function=criptoCurrencies",
                    {
                        ...
                        success: function(request) {
                            ...
                            var venta = calcPrecio(precio,criptomoneda.venta_signo,criptomoneda.venta_porcentaje).toFixed(1);
                            var compra = calcPrecio(precio,criptomoneda.compra_signo,criptomoneda.compra_porcentaje).toFixed(1);
                            html =
                                ...
                                '<div class="col3"><span class="moneda">USD&nbsp;</span><span class="compra">'+compra+'</span></div>' +
                                '<div class="col4"><span class="moneda">USD&nbsp</span><span class="venta">'+venta+'</span></div>' +
                                '</div>' +
                                '</div>';
                            $('#body').append(html);
                            ...
                            "panel/currencies/currencie.php?function=criptoCurrencies",
                            {
                                ...
                                success: function(request) {
                                    ...
                                    var precio = Number(request.USD);
                                        ...
                                        venta.html(calcPrecio(precio,criptomoneda.venta_signo,criptomoneda.venta_porcentaje).toFixed(1));
                                        compra.html(calcPrecio(precio,criptomoneda.compra_signo,criptomoneda.compra_porcentaje).toFixed(1));
