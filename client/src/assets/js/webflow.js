...
! function(t) {
    ...
    var a = o(n(26)),
        ...
        B = x.getComputedStyle,
        W = x.getInstanceOrigin,
                ...
                i ? function(t) {
                    ...
                    if ((0, f.default)(d)) {
                        (0, v.default)(d, function(t, e) {
                            ...
                            }(a.actionTypeId === P || ut(a.actionTypeId)) && It({
                                store: n,
                                actionListId: v,
                                eventId: f
                            })
    ...
    n(102), n(27), n(105), n(258), n(259), n(260), n(261), n(266), n(267), t.exports = n(268)
}, function(t, e, n) {
    "use strict";
    var r = n(4);
        ...
        return n.forEach(function(t, e) {
            if (!r || 0 !== e) {
                var n = t.actionItems,
                    ...
                    f = o.actionTypeId;
                i.id === o.id && (c = u + a);
                var l = x(f) === g.RENDER_GENERAL ? 0 : s.duration;
                u += s.delay + l
            }
    ...
    function C(t) {
        ...
        var N, C, L, P = (0, p.default)(n, "action.config.affectedElements", {})[_ || m] || {},
            D = Boolean(P.id || P.selector),
            x = n && u(w(n.target));
        if (D ? (N = P.limitAffectedElements, C = x, L = u(P)) : C = L = u({
                id: _,
                selector: m,
                selectorGuids: O
            }), n && R) {
        ...
        return null == C || null == L ? [] : y.IS_BROWSER_ENV && i ? c(L).filter(function(t) {
            return i.contains(t)
        }) : N === g.CHILDREN ? c(C, L) : N === g.IMMEDIATE_CHILDREN ? s(c(C)).filter(l(L)) : N === g.SIBLINGS ? f(c(C)).filter(l(L)) : c(L)
    }
    var L = /px/,
        P = function(t, e) {
    ...
    e.ixSession = function() {
        ...
        switch (e.type) {
            ...
            case v:
                for (var S = e.payload, R = S.width, b = S.mediaQueries, N = b.length, w = null, C = 0; C < N; C++) {
                    var L = b[C],
                        P = L.key,
                        D = L.min,
                        x = L.max;
    ...
    var c, s, f, l = u(n(26)),
        ...
        It = (r = {}, (0, o.default)(r, b, ht()), (0, o.default)(r, N, _t()), (0, o.default)(r, R, ht()), (0, o.default)(r, S, _t()), (0, o.default)(r, P, ht(!1)), (0, o.default)(r, L, _t(!1)), (0, o.default)(r, w, ht()), (0, o.default)(r, C, _t()), (0, o.default)(r, B, {
                ...
                switch (u) {
                    ...
                    case K:
                        var b = st(),
                            ...
                            C = b.scrollWidth,
                            L = b.scrollHeight;
                        A = m ? Math.min(N + I, C) / C : Math.min(w + y, L) / L;
                        break;
                    case Y:
                    default:
                        S = q(o, s);
            ...
            handler: function(t) {
                ...
                var w = R.top + Math.min(R.height * b, l),
                    ...
                    L = Math.min(l + C, f),
                    P = Math.min(Math.max(0, l - w), L) / L;
                return P !== o.scrollPercent && n.dispatch((0, h.parameterChanged)(S, P)), {
                    scrollPercent: P
                }
            }
        }), (0, o.default)(r, M, gt), (0, o.default)(r, j, gt), (0, o.default)(r, x, (0, l.default)({}, ut, {
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function m(n, i) {
            ...
            c || (c = t.data(i, v, {
                ...
                return function(n, r) {
                    r = r || {};
                    var i = f.width();
                    S(t), !0 === r.open && C(t, !0), !1 === r.open && P(t, !0), t.open && e.defer(function() {
                        i !== f.width() && R(t)
                    })
                }
            }(c))) : (! function(e) {
                if (e.overlay) return;
                e.overlay = t(p).appendTo(e.el), e.parent = e.menu.parent(), P(e, !0)
                ...
                return function(n) {
                    var i = t(this),
                        o = i.attr("href");
                    r.validClick(n.currentTarget) ? o && 0 === o.indexOf("#") && e.open && P(e) : n.preventDefault()
                }
            }(c))), N(n, i)
        }
        ...
        function N(e, n) {
            ...
            if (!r.open || i || a || P(r, !0), r.container.length) {
                var o = function(e) {
                    var n = e.container.css(w);
                    "none" === n && (n = "");
                    return function(e, r) {
                        (r = t(r)).css(w, ""), "none" === r.css(w) && r.css(w, n)
                    }
                }(r);
        ...
        function C(t, e) {
            if (!t.open) {
                ...
                var i = L(t),
                    ...
                    c = t.el.height(),
                    f = t.el[0];
                if (N(0, f), g.intro(0, f), r.redraw.up(), a || l.on("tap" + v, t.outside), !e) {
        ...
        function P(t, e) {
            ...
            function c() {
                t.menu.height(""), s(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.removeClass(h), t.links.removeClass(_), t.overlay && t.overlay.children().length && (I.length ? t.menu.insertAfter(I) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return c
    })
    ...
    r.define("tabs", t.exports = function(t) {
        ...
        function _() {
            n = f && r.env("design"), (e = u.find(d)).length && (e.each(T), r.env("preview") && !h && e.each(I), g(), r.redraw.on(o.redraw))
        }
        ...
        function y(e, n) {
            ...
            if (u !== e.current) {
                e.current = u, e.links.each(function(e, n) {
                    var r = t(n);
                    n.getAttribute(l) === u ? r.addClass(p).each(E.intro) : r.hasClass(p) && r.removeClass(p).each(E.outro)
                });
                var c = [],
                    f = [];
                ...
                var d = t(c),
                    _ = t(f);
                if (n.immediate || i.immediate) return d.addClass(v).each(E.intro), _.removeClass(v), void(h || r.redraw.up());
                _.length && i.outro ? (_.each(E.outro), a(_).add("opacity " + i.outro + "ms " + o, {
                    fallback: s
                }).start({
                    opacity: 0
                }).then(g)) : g()
            ...
            function g() {
                if (_.removeClass(v).css({
                        ...
                        width: "",
                        height: ""
                    }), d.addClass(v).each(E.intro), r.redraw.up(), !i.intro) return a(d).set({
                    opacity: 1
                });
                a(d).set({
                    opacity: 0
    ...
    "events": {
        "e-23": {
            ...
            "target": {
                ...
                "originalId": "5e04f5050b1ac53acbeb62a3|8db1fb83-7631-002b-b977-bfd36fc63395",
                "appliesTo": "CLASS"
            },
            "config": {
                "loop": false,
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".faq-answer",
                            "selectorGuids": ["0c60ce2b-1152-c83b-19de-dae157a74f61"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "PX"
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".faq-plus-l",
                            "selectorGuids": ["0c60ce2b-1152-c83b-19de-dae157a74f59"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "%"
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["0c60ce2b-1152-c83b-19de-dae157a74f57"]
                        },
                        "zValue": 180,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
